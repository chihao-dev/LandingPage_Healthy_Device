...
export default function Ecosystem({ initialProducts = [] }: EcosystemProps) {
  ...
  return (
    <div className="relative group/ecosystem">
      ...
      <button
        onClick={() => scroll('left')}
        className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 z-10 w-12 h-12 rounded-full bg-white dark:bg-slate-800 shadow-xl border border-slate-200 dark:border-white/10 flex items-center justify-center opacity-0 group-hover/ecosystem:opacity-100 transition-all hover:scale-110 active:scale-95 text-slate-600 dark:text-slate-300"
      >
