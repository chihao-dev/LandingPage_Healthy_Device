...
export default function LandingPage({ ecosystemComponent }: LandingPageProps) {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 dark:bg-[#050510] text-slate-900 dark:text-slate-100 font-sans scroll-smooth transition-colors duration-500 overflow-x-hidden selection:bg-blue-500/30 relative">
      ...
      <section id="problem" className="relative py-20 md:py-40 px-6 overflow-hidden bg-white dark:bg-[#020205] scroll-mt-20">
        ...
        <div className="max-w-5xl mx-auto relative z-10 space-y-20 md:space-y-40">
          ...
          <div className="reveal text-center max-w-4xl mx-auto space-y-6 md:space-y-8 glass p-6 md:p-12 rounded-[2rem] md:rounded-[3rem] border border-red-500/10 relative overflow-hidden">
      ...
      <section id="solution" className={`relative py-24 md:py-48 px-6 scroll-mt-20 transition-all duration-1000 ${isSolution ? 'bg-slate-100 dark:bg-[#030a1c]' : 'bg-slate-100 dark:bg-[#020205]'}`}>
        ...
        <div className="max-w-7xl mx-auto relative z-10 flex flex-col items-center">
          ...
          <div className="relative flex justify-center w-full reveal">
             <div className="relative w-full max-w-xl h-[400px] md:h-[800px] flex flex-col items-center justify-center -mt-10 md:-mt-20 overflow-visible transform hover:scale-[1.02] transition-transform duration-700 group z-10">
      ...
      <section id="technology" className="py-20 md:py-40 px-6 bg-white dark:bg-[#020205] relative border-t border-slate-200 dark:border-white/5 scroll-mt-20">
      ...
      <section id="realtime-data" className="py-20 md:py-40 px-6 bg-slate-100 dark:bg-[#050510] relative overflow-hidden border-t border-slate-200 dark:border-white/5 scroll-mt-20">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10 bg-white dark:bg-white/5 backdrop-blur-md p-8 md:p-24 rounded-[2rem] md:rounded-[3rem] border border-slate-200 dark:border-white/5 shadow-2xl">
          ...
          <div className="h-64 w-full flex items-end gap-0.5 md:gap-1.5 reveal p-4 md:p-6 rounded-2xl bg-slate-50 dark:bg-black/30 border border-slate-200 dark:border-white/5 relative shadow-inner overflow-hidden">
            ...
            {Array.from({ length: 48 }).map((_, i) => {
              ...
              return (
                <div
                  key={i}
                  className={`flex-1 rounded-t-sm transition-all duration-700 relative z-10 ${isHiddenOnMobile ? 'hidden sm:block' : ''}`}
                  style={{
      ...
      <section id="specs" className="py-20 md:py-32 px-6 bg-slate-100 dark:bg-[#020205] relative z-20">
      ...
      <section id="ecosystem" className="py-20 md:py-40 px-6 bg-slate-50 dark:bg-[#050510] border-t border-slate-200 dark:border-white/5 scroll-mt-20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12 md:mb-24 reveal">
            <h2 className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-indigo-500 font-bold tracking-[0.2em] uppercase text-sm mb-4">
